    ...
    return (
      <>
        ...
        <div
          ref={ref}
          className={cn(
            'fixed left-1/2 top-1/2 z-50 w-[calc(100vw-2rem)] max-w-2xl -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-[var(--primary)]/30 bg-[var(--card)] p-6 shadow-[var(--shadow-lg)] outline-none md:p-8',
