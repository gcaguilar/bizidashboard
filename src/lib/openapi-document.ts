export const openApiDocument = {
  ...
  paths: {
    ...
    '/api/transit/stops': {
      get: {
        operationId: 'get_transit_stops',
        summary: 'List transit stops with latest realtime snapshot',
        parameters: [
          {
            name: 'mode',
            in: 'query',
        ...
        responses: {
          200: {
            description: 'Transit stop payload'
          }
        }
      }
    },
    '/api/transit/alerts': {
      get: {
        operationId: 'get_transit_alerts',
        summary: 'List active transit alerts',
        parameters: [
          {
            name: 'mode',
            in: 'query',
        ...
        responses: {
          200: {
            description: 'Transit alerts payload'
          }
        }
      }
    },
    '/api/transit/rankings': {
      get: {
        operationId: 'get_transit_rankings',
        summary: 'List transit stop criticality rankings',
        parameters: [
          {
            name: 'mode',
            in: 'query',
        ...
        responses: {
          200: {
            description: 'Transit rankings payload'
          }
        }
      }
    },
    '/api/transit/patterns': {
      get: {
        operationId: 'get_transit_patterns',
        summary: 'Get hourly patterns for one transit stop',
        parameters: [
          {
            name: 'mode',
            in: 'query',
        ...
        responses: {
          200: {
            description: 'Transit pattern rows'
          }
        }
      }
    },
    '/api/transit/heatmap': {
      get: {
        operationId: 'get_transit_heatmap',
        summary: 'Get heatmap cells for one transit stop',
        parameters: [
          {
            name: 'mode',
            in: 'query',
        ...
        responses: {
          200: {
            description: 'Transit heatmap rows'
          }
        }
      }
    },
    '/api/transit/status': {
      get: {
        operationId: 'get_transit_status',
        summary: 'Get transit coverage and freshness status',
        parameters: [
          {
            name: 'mode',
            in: 'query',
        ...
        responses: {
          200: {
            description: 'Transit status payload'
          }
        }
      }
    },
