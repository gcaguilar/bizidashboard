  ...
  return (
    <PageShell className="gap-8 py-8 md:py-12">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {[
          { href: '/dashboard', title: 'Dashboard en vivo', desc: 'Mapa, alertas, flujo y lecturas operativas del sistema actual.' },
          { href: '/uso-bizi-por-estacion', title: 'Hub de estaciones', desc: 'Fichas publicas, disponibilidad, patrones y acceso al detalle operativo.' },
          { href: '/barrios-bizi-zaragoza', title: 'Barrios con cobertura', desc: 'Contexto territorial, estaciones destacadas y comparativa local por barrio.' },
          { href: '/informes', title: 'Archivo mensual', desc: 'Informes indexables por mes con enlaces persistentes y contexto historico.' },
          { href: '/estado', title: 'Estado del sistema', desc: 'Frescura de datos, volumen reciente y diagnostico rapido.' },
          { href: '/developers', title: 'Developers y API', desc: 'OpenAPI, ejemplos de consumo, CSV y documentacion reutilizable.' },
        ].map((link) => (
          <a
            key={link.href}
            href={link.href}
