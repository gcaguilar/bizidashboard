...
const GITHUB_REPO_URL = 'https://github.com/gcaguilar/biciradar';
...
export default function BiciRadarPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-[1280px] flex-col gap-8 overflow-x-clip px-4 py-8 md:px-6 md:py-12">
      ...
      <section className="rounded-2xl border border-[var(--border)] bg-[var(--surface-soft)] p-6">
        <div className="mb-6 text-center">
          <h2 className="text-2xl font-black text-[var(--foreground)] md:text-3xl">Unete a la beta</h2>
          <p className="mt-1 text-sm text-[var(--muted)]">Ayudanos a mejorar Bici Radar probando las versiones previas</p>
        </div>
