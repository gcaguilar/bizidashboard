...
function HorariosPage() {
  ...
  const canonicalPath = '/estadisticas/horarios';
    ...
    <PageShell>
      ...
      <header className="ui-page-hero">
        ...
        <div className="flex flex-wrap gap-3">
          <TrackedLink href={appRoutes.advancedMap()} ctaEvent={{ source: 'horarios_page', ctaId: 'open_map', destination: 'stats_map', sourceRole: 'hub', destinationRole: 'hub', transitionKind: 'within_public' }} className="ui-primary-button">Abrir mapa avanzado</TrackedLink>
        ...
        <section className="ui-section-card">
          ...
          <div className="mt-2 grid gap-3 md:grid-cols-2">
            {content.sectionItems.map((item) => {
              ...
              return (
                <TrackedLink key={`${item.title}-${item.href}`} href={item.href} navigationEvent={{ source: 'horarios_page_items', destination: item.href, sourceRole: 'hub', destinationRole: 'hub', transitionKind: 'within_public' }} className="group block transition hover:-translate-y-0.5">
