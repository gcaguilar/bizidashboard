      ...
      <div className="flex flex-wrap items-center gap-2 md:hidden">
        ...
        <Accordion className="relative">
          ...
          >
            ...
            <AccordionContent keepMounted className="absolute left-0 top-[calc(100%+0.5rem)] z-[9999] min-w-[200px] rounded-2xl border border-[var(--border)] bg-[var(--card)] p-3 shadow-[var(--shadow-soft)]">
