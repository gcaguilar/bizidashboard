...
export function AlertsPanel({ alerts, stations }: AlertsPanelProps) {
  ...
  return (
    <section className="dashboard-card h-full overflow-hidden">
      <header className="-m-4 mb-0 flex items-center justify-between gap-3 border-b border-[var(--accent)]/20 bg-[var(--accent)]/8 px-4 py-3">
      ...
      {activeAlerts.length === 0 ? (
        ...
        <ul className="max-h-[420px] space-y-2 overflow-auto pr-1 pt-2">
