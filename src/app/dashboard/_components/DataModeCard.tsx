...
export function DataModeCard({
  ...
  return (
    <section className="grid gap-4 lg:grid-cols-3 xl:grid-cols-5">
      ...
      <article className="ui-section-card">
        <h3 className="text-sm font-bold uppercase tracking-[0.12em] text-[var(--foreground)]">Estaciones con más problemas</h3>
        <p className="text-sm text-[var(--muted)]">Descarga las estaciones que pasan más horas vacías o llenas.</p>
        <Button asChild variant="cta" size="sm" className="mt-auto">
          <TrackedAnchor
            href={frictionCsvUrl}
            trackingEvent={buildExportClickEvent({
      ...
      <article className="ui-section-card">
        ...
        <p className="text-sm text-[var(--muted)]">Consulta el histórico de actividad, ocupación y equilibrio para analizarlo por tu cuenta.</p>
      ...
      <article className="ui-section-card">
        <h3 className="text-sm font-bold uppercase tracking-[0.12em] text-[var(--foreground)]">Histórico de alertas</h3>
      ...
      <article className="ui-section-card">
        ...
        <p className="text-sm text-[var(--muted)]">Descarga en CSV el estado y la actualización de los datos.</p>
        <Button asChild variant="cta" size="sm" className="mt-auto">
          <TrackedAnchor
            href={statusCsvUrl}
            trackingEvent={buildExportClickEvent({
