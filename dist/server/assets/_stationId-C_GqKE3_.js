...
import { i as isDistrictCollection, n as buildStationDistrictMap, r as fetchDistrictCollection } from "./districts-DMcc_jOx.js";
...
import { r as formatStatusDateTime } from "./system-status-BnLkTU-r.js";
...
import { t as Route } from "./_stationId-CsnBvrKI.js";
...
function getDayTypeForToday() {
	const day = Number(new Intl.DateTimeFormat("en-GB", {
		...
		weekday: "short"
	}).formatToParts(/* @__PURE__ */ new Date()).find((part) => part.type === "weekday")?.value === "Sun" ? 0 : new Intl.DateTimeFormat("en-GB", {
		timeZone: "Europe/Madrid",
		weekday: "short"
	}).formatToParts(/* @__PURE__ */ new Date()).find((part) => part.type === "weekday")?.value === "Sat" ? 6 : 1);
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("p", {
								...
								children: formatStatusDateTime(station.recordedAt)
							})]
						})
					})]
				})
...
//#endregion
//#region src/app/dashboard/estaciones/$stationId.tsx?tsr-split=component
function StationDetailRoute() {
	...
	}), /* @__PURE__ */ jsx(StationDetailPanel, {
		station,
		stations,
		rankings,
		alerts,
...
//# sourceMappingURL=_stationId-C_GqKE3_.js.map